...
// output: {
//   path: __dirname + '/pubic/js',
//   filename: 'bundle.js'
// }

// 7. Include the bundled file in the body of index.html
// 8. Run `webpack` - this will create `bundle.js` in the public/js directory
// 9. Open `index.html` in a browser and you should see "Hello World!" as defined at the top of this file
...
// 2. Define it as a loader for Webpack:
...
// 3. Run `webpack` again and make sure you can still load `index.html` in a browser
...
// 3. After 2 seconds, you should see the displayed text change from "Hello World!" to "Hello [Your Name]!"
...
/// REACT BASICS: setState
//////////////////////////////////////
// 1. Use 'getInitialState' to define a new state variable within the component called `textToDisplay`, and set it's value to `Hello World!`
// 2. Replace the "World" text in the `render` method with the value of this new state variable: `this.state.textToDisplay`
// 3. Run `webpack` and make sure you can still load `index.html` in a browser
...
// 3. Run `webpack` and make sure you can still load `index.html` in a browser
// 3. Remove the class name and use the `style` attribute to change the displayed text to red
// 3. Run `webpack` and make sure you can still load `index.html` in a browser
